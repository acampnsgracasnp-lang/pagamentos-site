...
module.exports = async function handler(req, res) {
  ...
  const preferenceBody = {
    ...
    back_urls: {
      ...
      // /sucesso lida com qualquer status (pendente/pago/recusado) via polling
      // do Firestore. Apontar pending para /sucesso evita o usuário cair em
      // /pendente e ficar sem o WhatsApp/mensagem quando o cartão aprovar.
    ...
    payment_methods: {
      // Pix é tratado pelo /api/criar-pix (Pix direto, sem Checkout Pro),
      // porque auto_return não dispara para Pix no Checkout Pro e o
      // usuário fica preso em congrats/instructions sem voltar pro site.
      // Aqui mantemos apenas cartão de crédito/débito.
